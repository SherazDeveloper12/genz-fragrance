          ...
          <div className="grid items-center gap-8 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="space-y-6">
              ...
              <div className="flex flex-col gap-4   ">
                <div className="flex gap-4 text-4xl font-bold text-red-500">
                  {product.discount > 0 ?
                    <>
                      <p className="text-4xl font-bold text-red-600 dark:text-zinc-50">PKR {product.price - Math.round((product.discount / 100) * product.price)}</p>
                      <p className="text-4xl font-bold text-red-700 dark:text-zinc-50 line-through decoration-2">PKR {product.price}</p>
                    </>
                    :
                    <p className="text-4xl font-bold text-red-700 dark:text-zinc-50 ">PKR {product.price}</p>
                  }
                </div>
                <div className="flex flex-wrap gap-3">
            ...
            <div className="rounded-[24px] border border-red-500/20 bg-black/60 p-4 shadow-inner shadow-red-950/40">
              <div className="relative overflow-hidden rounded-[20px] bg-zinc-900 p-4">
                <img
                  ...
                  className="h-96 w-full rounded-[16px] object-contain"
                />
              </div>
            </div>
          </div>
