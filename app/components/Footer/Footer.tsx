...
export default function Footer() {
  return (
    <div className='bg-black text-white p-6  flex flex-col gap-4 justify-center items-center '>
       <div className='flex justify-between items-start gap-4 flex-wrap w-full '>
    
        <div className="flez-1  flex flex-col gap-2 justify-center items-center ">
