      ...
      <AnimatePresence>
        {cartIsOpen &&
          ...
          <motion.div
            ...
            className='bg-neutral-800 text-white  fixed right-0 top-0 h-screen w-100 shadow-lg '>
            <div className='w-full h-full flex flex-col'>
              ...
              {items.length > 0 ? <div className='flex-1 flex flex-col gap-2 px-2 pt-6 pb-8 bg-black overflow-auto'>
                {items.map((item: any) => (
                  <div key={item.product.id} className='flex justify-between items-center bg-neutral-800 rounded-xl shadow-md gap-2  border-collapse p-2 hover:translate-y-1 duration-300 ease-in'>
